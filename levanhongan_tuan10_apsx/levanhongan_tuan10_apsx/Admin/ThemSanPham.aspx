<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ThemSanPham.aspx.cs" Inherits="levanhongan_tuan10_apsx.Admin.ThemSanPham" EnableEventValidation="false" %>
            ...
            <div class="p-5">
                <div class="text-center">
                   ...
                   <%-- <h1 class="h4 text-gray-900 mb-4">Thêm Sản Phẩm</h1>--%>
                    <asp:Label ID="lbl_title" runat="server" Text="Thêm Sản Phẩm" CssClass="h4 text-gray-900 mb-4"></asp:Label>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <asp:TextBox ID="Type" type="text" CssClass="form-control form-control-user" runat="server" placeholder="Type"></asp:TextBox>
                ...
                <div class="form-group row">
                     <div class="col-lg-4 col-sm-6">
                        <%--<asp:TextBox ID="TextBox1" type="text" CssClass="form-control form-control-user" runat="server" placeholder="Username"></asp:TextBox>--%>
                         <asp:DropDownList ID="DDL_status" runat="server" CssClass="form-control form-control-user">
                             ...
                             <asp:ListItem Value="0">Còn</asp:ListItem>
                             <asp:ListItem Value="1">Hết</asp:ListItem>
                         </asp:DropDownList>
