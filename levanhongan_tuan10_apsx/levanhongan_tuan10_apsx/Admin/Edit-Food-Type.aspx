<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Edit-Food-Type.aspx.cs" Inherits="levanhongan_tuan10_apsx.Admin.Edit_Food_Type" %>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-sm-6">
                       ...
                       <%-- <asp:TextBox ID="Img" CssClass="form-control form-control-user" runat="server" placeholder="Type Img"></asp:TextBox>--%>
                        <asp:Image ID="type_img" runat="server" />
...
<%--                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Không được để trống!!!" ControlToValidate="FileUpload1" ForeColor="Red"></asp:RequiredFieldValidator>--%>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Không được để trống!!!" ControlToValidate="user" ForeColor="Red"> </asp:RequiredFieldValidator>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Không được để trống!!!" ControlToValidate="Modified" ForeColor="Red"></asp:RequiredFieldValidator>
                    </div>

                </div>
            </div>

            <asp:Button ID="btnUpdate" runat="server" Text="Lưu" CssClass=" btn btn-primary btn-user btn-block" OnClick="btnUpdate_Click" />
